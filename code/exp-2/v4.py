...
# %%
tempList=[1000,200,300,400,500,600,700,800,900,1000,1200,1400,1600,1800,2000]
...
data=[]
with open('results-4.csv', 'w', encoding='UTF8', newline='') as f:
  writer = csv.writer(f)
...
for event in experiment:
  ...
  with open('results-4.csv', 'a', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
    # writer.writerow(header)
    writer.writerow(row)
