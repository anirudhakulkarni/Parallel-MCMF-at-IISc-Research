...
#include "min_cost_max_flow-v2.hpp"
#include <string>
#include <tuple>
#define ln "\n"
...
int main()
{
  ...
  { 
    ...
    for (int i = 0; i < experiments.size(); i++)
    {
        ...
        // }
        // boost::SampleGraph G;
        boost::SampleGraph::vertex_descriptor s0, t0;
        boost::SampleGraph::Graph g0;
        boost::SampleGraph::vertex_descriptor s, t;
        boost::SampleGraph::Graph g;
        tie(g,s,t)=boost::SampleGraph::getSampleGraph(g0, s0, t0, sources, sinks, edges);
                cout<<"Edges\n";
        for (int i = 0; i < edges.size(); i++)
        {
            out4(edges[i][0],edges[i][1],edges[i][2],edges[i][3]);
...
//  print_dependencies(std::cout, g, );
 boost::VertexNameMap name_map=get(vertex_name, g)
